...
module.exports={
    ...
    createBot(clientId, botToken, username, projectName){
        ...
        let cmd="mkdir -p "+dest+" && cp ../base/index.js "+dest+"&& cp ../base/deploy-commands.js "+dest+" && touch "+dest+"/afkusers.json "+dest+"/remindusers.json "+dest+"/database.json "+dest+"/listeners.json "
